...
columns = ["Sex", "Lenght", "Diameter", "Height", "Whole_weight", "Shucked_weight", "Viscera_weight", "Shell_weight",
           "Rings"]
...
nx.draw_networkx_labels(g, pos, labels=columns_dict, font_size=6)
plt.show()

columns = ["Smoking", "Yellow_Fingers", "Anxiety", "Peer_Pressure", "Genetics", "Attention_Disorder",
           "Born_an_Even_Day", "Car_Accident", "Fatigue", "Allergy", "Coughing", "Lung_Cancer"]
